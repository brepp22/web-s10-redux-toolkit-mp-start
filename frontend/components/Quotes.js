...
import { toggleDisplayAllQuotes, toggleHighlightedQuote, toggleApocryphal, deleteQuote } from '../state/quotesSlice'
...
export default function Quotes() {
  ...
  return (
    <div id="quotes">
            ...
            .map(qt => (
              ...
              >
                ...
                <div className="quote-buttons">
                  ...
                  <button onClick={() => dispatch(toggleHighlightedQuote(qt.id))}>HIGHLIGHT</button>
                  <button onClick={() => dispatch(toggleApocryphal(qt.id))}>FAKE</button>
                </div>
              </div>
            ))
        }
      ...
      {!!quotes?.length && <button onClick={() => dispatch(toggleDisplayAllQuotes())}>
